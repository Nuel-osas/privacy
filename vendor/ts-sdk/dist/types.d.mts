...
import { DiscreteLogTable, EncryptedAmount, MultiRecipientEncryption, PrivateKey } from "./twisted_elgamal.mjs";
 ...
 */
type ContraCompatibleClient = ClientWithCoreApi;
/**
 ...
 */
interface VerifiedKeyEncryption {
...
type AuditorVersionEntry = {
  /** This auditor's index in the auditor `pks` list of the given version. */index: number; /** This auditor's twisted ElGamal private key for that version. */
  privateKey: PrivateKey;
};
/** Options for constructing a `ContraAuditor`. */
interface ContraAuditorOptions {
  suiClient: ContraCompatibleClient;
  /** Addresses of the contra Move package and its shared registries. */
  packageConfig: ContraPackageConfig;
 ...
 */
type AuthThunk = (tx: Transaction) => TransactionObjectArgument;
...
interface BatchedTransferRecipient {
  /** The receiver's address. */
  receiverAddress: string;
...
interface UnpauseAccountOptions {
...
interface RotateKeyAndTransferBatchOptions {
...
//#endregion
export { AccountStatus, AuditorVersionEntry, BalanceEntry, BatchedTransferOptions, BatchedTransferRecipient, ContraAuditorOptions, ContraClientOptions, ContraCompatibleClient, ContraOptions, ContraPackageConfig, NewAccountOptions, PauseAccountOptions, RegisterOptions, RotateKeyAndTransferBatchOptions, RotateKeyOptions, ShareAccountOptions, TokenAuditors, TokenBalance, TransferOptions, UnpauseAccountOptions, UnwrapOptions, UpdateBalanceOptions, VerifiedKeyEncryption, WrapOptions };