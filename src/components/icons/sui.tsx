...
export function SuiIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className={cn("shrink-0", className)}>
      <defs>
        <linearGradient id="sui-bg" x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#6FBCF0" />
          <stop offset="100%" stopColor="#4DA2FF" />
        </linearGradient>
      </defs>
      <circle cx="16" cy="16" r="16" fill="url(#sui-bg)" />
